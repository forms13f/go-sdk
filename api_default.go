...
type ApiApiV1HoldersGetRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
	cusip *string
...
func (r ApiApiV1HoldersGetRequest) Cusip(cusip string) ApiApiV1HoldersGetRequest {
	r.cusip = &cusip
	return r
}

// The period of report date.
func (r ApiApiV1HoldersGetRequest) PeriodOfReport(periodOfReport string) ApiApiV1HoldersGetRequest {
	r.periodOfReport = &periodOfReport
	return r
}

func (r ApiApiV1HoldersGetRequest) Execute() (*ApiV1HoldersGet200Response, *http.Response, error) {
	return r.ApiService.ApiV1HoldersGetExecute(r)
}

/*
ApiV1HoldersGet Retrieve CIKs for a given CUSIP and period of report.

Returns a JSON object containing the CUSIP, period of report, and an array of CIKs.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1HoldersGetRequest
*/
func (a *DefaultAPIService) ApiV1HoldersGet(ctx context.Context) ApiApiV1HoldersGetRequest {
	return ApiApiV1HoldersGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultAPIService) ApiV1HoldersGetExecute(r ApiApiV1HoldersGetRequest) (*ApiV1HoldersGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiV1HoldersGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.ApiV1HoldersGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/holders"
	...
	if r.periodOfReport == nil {
		return localVarReturnValue, nil, reportError("periodOfReport is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "cusip", r.cusip, "", "")
	parameterAddToHeaderOrQuery(localVarQueryParams, "period_of_report", r.periodOfReport, "", "")
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiApiV1TopfundsGetRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
	quarter *string
	limit *int32
...
// The quarter in the format YYYYQn (e.g. 2025Q4).
func (r ApiApiV1TopfundsGetRequest) Quarter(quarter string) ApiApiV1TopfundsGetRequest {
	r.quarter = &quarter
	return r
}

// The maximum number of funds to return.
func (r ApiApiV1TopfundsGetRequest) Limit(limit int32) ApiApiV1TopfundsGetRequest {
	r.limit = &limit
	return r
}

// The offset for pagination.
func (r ApiApiV1TopfundsGetRequest) Offset(offset int32) ApiApiV1TopfundsGetRequest {
	r.offset = &offset
	return r
}

func (r ApiApiV1TopfundsGetRequest) Execute() ([]ApiV1TopFund, *http.Response, error) {
	return r.ApiService.ApiV1TopfundsGetExecute(r)
}

/*
ApiV1TopfundsGet Get top funds by PnL for a given quarter.

Retrieve the top funds ranked by PnL for a specific quarter.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1TopfundsGetRequest
*/
func (a *DefaultAPIService) ApiV1TopfundsGet(ctx context.Context) ApiApiV1TopfundsGetRequest {
	return ApiApiV1TopfundsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ApiV1TopFund
func (a *DefaultAPIService) ApiV1TopfundsGetExecute(r ApiApiV1TopfundsGetRequest) ([]ApiV1TopFund, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ApiV1TopFund
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.ApiV1TopfundsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/topfunds"
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "quarter", r.quarter, "", "")
	if r.limit != nil {
        parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "", "")
	} else {
