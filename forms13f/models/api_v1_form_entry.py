...
class ApiV1FormEntry(BaseModel):
    ...
    first_quote: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price of the asset at the time of the filing (entry price).")
    last_quote: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The latest close price of the asset.")
    last_date: Optional[date] = Field(default=None, description="The date of the latest close price.")
    __properties: ClassVar[List[str]] = ["accession_number", "cik", "name_of_issuer", "title_of_class", "cusip", "ticker", "value", "ssh_prnamt", "ssh_prnamt_type", "investment_discretion", "voting_authority_sole", "voting_authority_shared", "voting_authority_none", "put_call", "first_quote", "last_quote", "last_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if first_quote (nullable) is None
        # and model_fields_set contains the field
        if self.first_quote is None and "first_quote" in self.model_fields_set:
            _dict['first_quote'] = None

        # set to None if last_quote (nullable) is None
        # and model_fields_set contains the field
        if self.last_quote is None and "last_quote" in self.model_fields_set:
            _dict['last_quote'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "first_quote": obj.get("first_quote"),
            "last_quote": obj.get("last_quote"),
