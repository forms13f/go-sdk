...
class ApiV1Fund(BaseModel):
    """
    ApiV1Fund
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the company.")
    cik: Optional[StrictStr] = Field(default=None, description="The CIK of the company.", alias="CIK")
    __properties: ClassVar[List[str]] = ["name", "CIK"]
