...
**first_quote** | **float** | The price of the asset at the time of the filing (entry price). | [optional] 
**last_quote** | **float** | The latest close price of the asset. | [optional] 
**last_date** | **date** | The date of the latest close price. | [optional] 
